                ...
                <div class="col-lg-12">
                    <div class="container clearfix">
                        ...
                        <div class="col-md-12">
                            ...
                            <form name="f1" id="orderform" action="<?= base_url ?>order/add" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-outline mb-4" onchange>
                                    ...
                                    <input type="text" id="direc" name="direccion" class="form-control" value="<?= isset($data['direccion']) ? ($data['direccion']) : '' ?>" />
                   ...
                   <div id="paypal-button-container">       </div>
                     ...
                     <script  type="text/javascript" src="<?=base_url?>assets/js/api_paypal.js?2.7" media="all"></script>  
                        </div>
                    </div>
                </div>
