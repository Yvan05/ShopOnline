                    ...
                    <?php if (isset($_SESSION['identity'])):
                        ...
                        <div class="user-pic">
                            ...
                            <?php if ($user->imagen != NULL): ?>
                                <img class="img-responsive img-rounded" src="<?= base_url ?>profile/img/<?= $user->imagen ?>"
                                    alt="User picture">
                            <?php else: ?>
                                <img class="img-responsive img-rounded" src="<?= base_url ?>assets/img/DefaultUser.png"
                                    alt="User picture">
                            <?php endif; ?>
                    ...
                    <div>
                        <form action="<?= base_url . 'product/buscador' ?>" method="POST">
                            <div class="input-group">
                                ...
                                <input type="text" name="busca" class="form-control search-menu"
                                    placeholder="Search...">
                    ...
                    <ul>
                        ...
                        <?php else: ?>
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="<?= base_url ?>user/view">Perfil</a>
                                    </li>
                                    <li>
                                ...
                                <li  class="sidebar-dropdown">
                                    ...
                                    <div  class="sidebar-submenu">
                                        <ul>
                                            ...
                                            <li>
                                                <a href="<?= base_url ?>user/gestion">Gestion de Usuarios</a>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <?php while ($cat = $categorias->fetch_object()): ?>
                                        <li>
                                            <a href="<?= base_url ?>category/ver&id=<?= $cat->id; ?>">
                                                <?= $cat->nombre ?>
                                            </a>
                                        </li>
                                    <?php endwhile; ?>
