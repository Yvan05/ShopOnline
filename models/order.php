...
class order
{
    ...
    {
        //eliminando relacion entre lineas de pedido y pedidos
        $query1 = "DELETE FROM lineas_pedido WHERE pedido_id={$this->id}";
        $pedido1 = $this->db->query($query1);
        if ($pedido1) {
            $query = "DELETE FROM pedidos WHERE id={$this->id}";
